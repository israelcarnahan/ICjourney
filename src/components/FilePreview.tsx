...
import { FileText, Star, Clock, Calendar, AlertTriangle, Edit, Trash2 } from 'lucide-react';
...
const FilePreview: React.FC<FilePreviewProps> = ({ files, onEdit, onDelete, maxFiles }) => {
