  ...
  const handleReschedule = useCallback(async () => {
    ...
    try {
      ...
      const timeoutPromise = new Promise((_, reject) => {
        setTimeout(() => reject(new Error('Schedule generation timed out')), 15000);
      });
      ...
      let availablePubs = allPubs.filter(pub => !scheduledPubNames.has(pub.pub));
      ...
      const sortedPubs = [...nearbyPubs].sort((a, b) => {
        const priorityOrder = { RecentWin: 0, Wishlist: 1, Unvisited: 2, Masterfile: 3 };
        ...
        >
          <div className="flex justify-between items-center mb-6">
            ...
            <div id="reschedule-dialog-description" className="sr-only">
              Reschedule visits for {formatDateSafely(day.date)}. Select a new area and configure visit settings.
            </div>
            {error && (
            ...
            <div className="mb-6">
              <div className="flex items-start gap-3 p-4 rounded-lg bg-eggplant-800/50">
                ...
                <div>
                  ...
                  <p className="text-sm text-eggplant-200 mt-1">
                    This will generate a new schedule for {formatDateSafely(day.date)} using pubs near {postcode}.
