 ...
 * Logic salvage: Optional: reuse area grouping + color scaling in [see src/components/RepStatsPanel.tsx](../../src/components/RepStatsPanel.tsx).
 * Verdict: ARCHIVE
 *
 * Notes: This file is for reference only, to review when ready to resurrect. Do not modify except during explicit "resurrection" work.
...
const CoverageHeatMap: React.FC<CoverageHeatMapProps> = ({
  ...
  const coverage = useMemo(() => {
    ...
    return Array.from(areas.entries()).sort(([a], [b]) => a.localeCompare(b));
  }, [schedule, allPubs]);
              ...
              <Tooltip.Trigger asChild>
                ...
                >
                  <div className="text-center">
                    <div className="text-lg font-bold text-eggplant-100">
                      {area}
                    </div>
              ...
              <Tooltip.Portal>
                ...
                >
                  <div className="space-y-1">
                    ...
                    <p>
                      Scheduled: {stats.scheduled} of {stats.total}
                    </p>
                  </div>
