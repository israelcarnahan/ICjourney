 ...
 * Intent duplication: Replacement logic exists without dialog UI in [see src/components/ScheduleDisplay.tsx](../../src/components/ScheduleDisplay.tsx).
 * Hidden coupling risk: None found.
 * Logic salvage: Optional: reuse the dialog UX with `handleVisitReplace` in [see src/components/ScheduleDisplay.tsx](../../src/components/ScheduleDisplay.tsx).
 * Verdict: ARCHIVE
 *
    ...
    <AlertDialog.Root>
      <AlertDialog.Trigger asChild>
        <button
          ...
          aria-describedby="remove-pub-dialog-description"
        >
          <X className="h-5 w-5" />
        </button>
      </AlertDialog.Trigger>
        ...
        <AlertDialog.Content className="fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full max-w-md animated-border bg-gradient-to-r from-eggplant-900/90 via-dark-900/95 to-eggplant-900/90 rounded-lg p-6">
          <div className="flex items-start gap-3 mb-4">
            ...
            <div>
              ...
              <div id="remove-pub-dialog-description" className="sr-only">
                Confirm removal of {visit.pub} from schedule. A replacement pub may be suggested.
              </div>
