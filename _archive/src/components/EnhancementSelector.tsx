 ...
 * Real usage check: Only a commented-out JSX reference in [see src/pages/PlannerDashboard.tsx](../../src/pages/PlannerDashboard.tsx); no live imports.
 * Intent duplication: Active upload flow is [see src/components/FileUploader.tsx](../../src/components/FileUploader.tsx) with selection UI in [see src/components/FileTypeDialog.tsx](../../src/components/FileTypeDialog.tsx).
 * Hidden coupling risk: Low; references [see src/config/maps.ts](../../src/config/maps.ts) which is already used elsewhere.
 * Logic salvage: Optional: reuse the option-card UX or simplified parser in [see src/components/FileUploader.tsx](../../src/components/FileUploader.tsx).
 * Verdict: ARCHIVE
 *
